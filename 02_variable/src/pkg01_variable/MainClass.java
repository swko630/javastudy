...
public class MainClass {
  ...
  public static void main(String[] args) {
     ...
     *    ㄴ 주소값 또는 참조값이라고 한다.
     *    ㄴ 16진수 작성 예시 : 0x123abc456
     */
    
    /*
     * 식별자의 이름 규칙 (권장) - 개발자들의 규칙
    ...
    // long : 8바이트 정수(숫자 뒤에 L을 붙일 수 있다.)
    long c = 10L;
    System.out.println(c);
    
    // float : 4바이트 실수(숫자 뒤에 F를 붙일 수 있다.)
    float d = 1.1f;
     ...
     * |             |
     * |-------------|
     * | hello world | 0x12345678 -> hello world의 참조값
     * |-------------|
     * |             |
     * └-------------┘
     */
    String s = "hello world"; // s는 hello world의 참조값을 저장한다.
