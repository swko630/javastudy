...
public class MainClass {
   ...
   * 1. 쿼리문을 실행하는 역할을 가진다.
   * 2. PreparedStatement 객체 생성 이전에 쿼리문이 완성되어 있어야 한다. (Statement는 보안상 사용X)
  ...
  public static void method3() {
    ...
    try {
      ...
      // 입력값을 쿼리문에 전달
      ps.setInt(1, sampleNo); // 쿼리문의 첫번째 물음표에 sampleNo 전달
  ...
  public static void method4() {
   ...
   try {
     ...
     String sql = "DELETE FROM SAMPLE_T WHER SAMPLE_NO = ?";
     ps = con.prepareStatement(sql);
     Scanner sc = new Scanner(System.in);
