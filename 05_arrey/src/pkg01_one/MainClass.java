...
public class MainClass {
  ...
  public static void method1() {
     ...
     * 3. 배열의 생성
     *    new int[배열길이]
     * 4. 배열이 생성되면 배열의 모든 요소는 자동으로 초기화된다. - 변수는 자동 초기화 없음
     *    0, 0.0, false, null
     * 
     */
  ...
  public static void method2() {
     ...
     * 2. 형식
     *    1) int[] 배열이름 = new int[]{값1, 값2, 값3, ...} - 1번도 써야할 때가 있다.
     *    2) int[] 배열이름 = {값1, 값2, 값3, ...}
     */
  ...
  public static void method3() {
    ...
    // 배열과 for
    for(int i = 0; i < arr.length; i++){// 개발자들의 배열의 for문은 이렇게 정형화 되어있다.(변수 i도 관례상 i로 항상 적음)
  ...
  public static void method5() {
    // advanced for   -- 배열의 값을 바꿀 수 없고 단순 참조만 할 때
    // for(변수 : 배열) { }
    int[] arr = new int[] {10, 20, 30, 40, 50};
    for(int number : arr) {
