...
public class MainClass {
  ...
  public static Map<String, Object> method2(String id) {
    ...
    case "1":
    case "2": birthYear = 1900 + Integer.parseInt(id.substring(0, 2));
    break;
    case "3":
    case "4":
    ...
    // 성별 : 하이픈 뒤의 숫자가 1,3 이면 남, 2,4이면 여
...
//    int withdraw = 0;
//    withdraw++ ;
//    int withdrawal = (int)(Math.random() * 5000);
//    balance = balance - withdrawal;
//    while (balance > 0 ) {
//      System.out.println("출금 전 " + balance + "원, " + withdraw + "회 출금액 " + withdrawal + "원, " + "출금 후 " + (balance - withdrawal) + "원");
//    
//      if (balance == 0) { 
//        System.out.println("돈을 모두 출금하였습니다.");
//       
//        break;        
//      }
//    
